...
Pod::Spec.new do |s|
  s.name             = 'Ham'
  s.version          = '0.1.20'
  s.summary          = 'francis private core'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
francis private core with objective-C
                       DESC
  ...
  s.subspec 'Core' do |c|
    c.source_files = 'Ham/Classes/Core/**/*'
    c.public_header_files = 'Ham/Classes/Core/**/*.h'
  end
  s.subspec 'UI' do |u|
    u.source_files = 'Ham/Classes/UI/**/*'
    u.public_header_files = 'Ham/Classes/UI/**/*.h'
    u.dependency 'Ham/Core'
  end
